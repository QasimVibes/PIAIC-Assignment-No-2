...
var totalPrice = 100;
if (totalPrice > 100) {
    var discount_amount = totalPrice * 0.1; // 10% discount
    var discounted_price = totalPrice - discount_amount;
    console.log(`Congratulations! You've received a 10% discount. Your total bill is ${discounted_price}$`);
}
else {
    var discount_amount = totalPrice * 0.05; // 5% discount
    var discounted_price = totalPrice - discount_amount;
    console.log(`Congratulations! You've received a 5% discount. Your total bill is ${discounted_price}$`);
}
...
if (units > 100 && units <= 200) {
    var addTax = units * 0.1; // 10% tax
    var totalBill = (units + addTax) * amountPerUnit;
    console.log(`Your total units is ${units}, and your total bill is ${totalBill} with 10% tax.`);
}
else if (units > 200 && units <= 500) {
    var addTax = units * 0.15; // 15% tax
    var totalBill = (units + addTax) * amountPerUnit;
    console.log(`Your total units is ${units}, and your total bill is ${totalBill} with 15% tax.`);
}
else if (units > 500) {
    var addTax = units * 0.25; // 25% tax
    var totalBill = (units + addTax) * amountPerUnit;
    console.log(`Your total units is ${units}, and your total bill is ${totalBill} with 25% tax.`);
}
else {
    var totalBill = units * amountPerUnit;
    console.log(`Your total units is ${units}, and your total bill is ${totalBill} with 0% tax.`);
}
